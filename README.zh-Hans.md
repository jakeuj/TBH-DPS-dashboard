...
**TaskBarHero**（TBH: Task Bar Hero）的游戏内 **DPS / 承受伤害 / 关卡比较 / 刷关效率 / 宝箱记录 / 开箱统计 / 掉宝热力图** 监控插件，
...
<img src="image/hub-panel.png" alt="中控台" width="300">
...
- **F4** — 显示/隐藏 开箱统计面板（可设置：`BoxOpenUI.ToggleKey`）
