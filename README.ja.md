...
**TaskBarHero**（TBH: Task Bar Hero）向けのゲーム内 **DPS / 被ダメージ / ステージ比較 / 周回効率プランナー / 宝箱ログ / 開封統計 / ドロップ分布** オーバーレイ。すべて **F1 コントロール（コントロールセンター）** から表示切替できます。
...
<img src="image/hub-panel.png" alt="コントロールセンター" width="300">
...
- **F4** — 開封統計パネルの表示/非表示（設定可：`BoxOpenUI.ToggleKey`）
